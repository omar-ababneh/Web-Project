...
public class ProcessLoginAction implements Action{
    @Override
    public void execute(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        User user= dataBaseDAO.Login(Email,Password,TypeUser);
        ...
        if(user!=null){
            ...
            if(TypeUser.equals("Student")){
                Map<String,String> map= dataBaseDAO.getAllCoursesForStudent(String.valueOf(user.getID()));
                ...
                Map <String,String> map= dataBaseDAO.getAllCoursesForInstructor(String.valueOf(user.getID()));
                httpServletRequest.setAttribute("Courses",map);
                httpServletRequest.setAttribute("FName",user.getFName());
